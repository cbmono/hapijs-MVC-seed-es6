...
describe( 'Model: BaseModelRDMS', () => {
    ...
    describe('save/update methods', () => {
        let name = 'Some cool name',
            ...
            knexRes, insertRes, updateRes

        beforeEach(() => {
            spyOn(model, 'dbConfig').and.returnValue({
                client: 'pg'
            })
            ...
            insertRes = (spyOn(knexRes, 'insert').and.returnValue({
                returning: () => {}
            }))()
            spyOn(insertRes, 'returning').and.returnValue(Promise.resolve({}))

            updateRes = (spyOn(knexRes, 'update').and.returnValue({
                whereIn: () => {}
            }))()
    ...
    describe('delete methods', () => {
        ...
        beforeEach(() => {
            ...
            deleteRes = (spyOn(knexRes, 'del').and.returnValue({
                whereIn: () => {}
            }))()
